...
var ShowCollections = function ShowCollections() {
  ...
  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].to(button.current, 2, {
    x: 400,
    ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Power3"].easeIn
  }).pause()),
      tween = _useState2[0],
      setTween = _useState2[1];

  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    tween.play();
  }, [tween]); // console.log(clickAnimation)
  ...
  var handleClick = function handleClick() {
    ...
    setTween(gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].to(button.current, 2, {
      x: 400,
      ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Power3"].easeIn
    }).pplay()); // clickAnimation.play()
  };
...
//# sourceMappingURL=index.js.09aa669d32fe063ea6d3.hot-update.js.map