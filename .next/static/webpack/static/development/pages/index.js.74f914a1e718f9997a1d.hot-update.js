...
var ShowCollections = function ShowCollections() {
  ...
  var _useContext = Object(react__WEBPACK_IMPORTED_MODULE_1__["useContext"])(_contexts_CollectionsContext__WEBPACK_IMPORTED_MODULE_3__["CollectionsContext"]),
      collections = _useContext.collections,
      dispatch = _useContext.dispatch;

  var button = Object(react__WEBPACK_IMPORTED_MODULE_1__["useRef"])(null);

  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(gsap__WEBPACK_IMPORTED_MODULE_4__["TweenMax"].to(button.current, {
    duration: 2,
    x: 100
  }).pause()),
      clickAnimation = _useState2[0],
      setClickAnimation = _useState2[1]; // const [timeline] = useState(new TimelineMax({paused: true}))
  // useEffect(() => {
  //     setClickAnimation(TweenMax.to(button.current, { duration: 2, x: 100}).pause());
  // },[timeline])
  ...
  return __jsx(CollectionsContainer, {
    ref: function ref(el) {
      button = (Object(_babel_runtime_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_0__["default"])("button"), el);
    },
...
//# sourceMappingURL=index.js.74f914a1e718f9997a1d.hot-update.js.map