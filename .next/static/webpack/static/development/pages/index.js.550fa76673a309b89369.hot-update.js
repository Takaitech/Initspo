...
})(["width:", "px;height:", "px;max-height:150px;margin:10px;background-image:url(", ");background-size:cover;list-style:none;display:inline-block;background-repeat:no-repeat;float:left;background-position:center;"], function (props) {
  return prop.content.dimensions.width / 4;
}, function (props) {
  return prop.content.dimensions.height / 4;
}, function (props) {
  return props.url;
});
...
//# sourceMappingURL=index.js.550fa76673a309b89369.hot-update.js.map