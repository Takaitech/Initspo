...
})(["width:", "};height:", "px;max-height:150px;margin:10px;background-image:url(", ");background-size:cover;list-style:none;background-repeat:no-repeat;float:left;background-position:center;display:", ""], function (props) {
  return props.showGrid || props.selected ? '100%' : props.content.dimensions.width / 4 + 'px';
}, function (props) {
...
//# sourceMappingURL=index.js.c033d1c604bf46bd2484.hot-update.js.map